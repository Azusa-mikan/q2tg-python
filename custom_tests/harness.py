...
TEST_ITEMS: tuple[TestItem, ...] = (
    ...
    TestItem("image-album-q-to-tg", "在 OneBot 群一次发送 2 至 10 张图片，每张不超过 10 MB且合计不超过 49 MiB。", label_prefix="onebot-to-telegram:", capability="onebot.image-album.photo"),
    TestItem("image-album-document-q-to-tg", "在 OneBot 群一次发送 2 张图片，其中一张必须大于 10 MB 但不超过 32 MiB（超过会触发客户端自带的文件发送），合计不超过 49 MiB。", label_prefix="onebot-to-telegram:", capability="onebot.image-album.document"),
    TestItem("image-document-q-to-tg", "在 OneBot 群发送一张大于 10 MB、不超过 32 MiB 的图片（超过会触发客户端自带的文件发送）。", label_prefix="onebot-to-telegram:", capability="onebot.image.document"),
    TestItem("video-q-to-tg", "在 OneBot 群发送一个不超过 50 MB 的视频。", label_prefix="onebot-to-telegram:", capability="onebot.media.video"),
    ...
    TestItem("video-too-large-q-to-tg", "在 OneBot 群发送一个大于 50 MB 的视频；应收到不转发提示。", label_prefix="onebot-media-rejected:", capability="onebot.media.rejected"),
    ...
    TestItem("file-q-to-tg", "在 OneBot 群发送一个不超过 50 MB 的文件。", label_prefix="onebot-to-telegram:", capability="onebot.media.file"),
    TestItem("file-tg-to-q", "在 Telegram 群发送一个不超过 20 MB 的文件。", label_prefix="telegram-to-onebot:", capability="telegram.media.file"),
    TestItem("file-too-large-q-to-tg", "在 OneBot 群发送一个大于 50 MB 的文件；应收到不转发提示。", label_prefix="onebot-media-rejected:", capability="onebot.media.rejected"),
