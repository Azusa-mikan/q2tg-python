...
_SUPER_FACE_PACKS = {
    "qlottie_2": "364 362 397 396 360 361 363 365 367".split(),
    "qlottie_3": "413 405 404 406 411 407 408 412 409".split(),
    "qlottie_4": "403 402 390 391 388 389 386 385 384 387".split(),
    "qlottie_5": "382 383 401 400 380 381 379 376 378 377".split(),
    "qlottie_6": "399 398 373 370 375 368 369 371 372 374".split(),
    "QQAniSticker": "5 311 312 319 320 339 137 346 344 345 181 74 75 349 350".split(),
    "qq_snake": "429 430 431_1 431_2 431_3 431_4 431_5 431_6 432".split(),
}
